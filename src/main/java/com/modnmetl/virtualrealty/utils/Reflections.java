...
public final class Reflections {
    ...
    private static final Method INVALID_METHOD = SafeUtil.safeInit(() -> InvalidMarker.class.getDeclaredMethod("invalidMethodMaker"));
    ...
    public static Class<?> getClass(String className) {
        ...
        try {
            ...
            System.err.println("Could not retrieve class");
    ...
    public static Object getHandle(Entity entity) {
        try {
            ...
            System.err.println("Could not get entity handle");
            return null;
        }
    }
    ...
    public static Object getHandle(World world) {
        try {
            ...
            System.err.println("Could not get world handle");
    ...
    public static Field getField(Class<?> cl, String fieldName) {
        ...
        try {
            ...
            System.err.println("Could not retrieve field");
